...
{% include image.html img="images/EDA/iriskeys.png" title="title for image" caption="keys of iris" %}
...
{% include image.html img="images/EDA/irisdescr.png" title="title for image" caption="shape of data" %}
...
{% include image.html img="images/EDA/irisspecies.png" title="title for image" caption="target variable labels" %}
